...
listaElementos.addEventListener('click', (e) => {
    ...
    if(e.target.innerHTML === 'Editar'){
        ...
        var universidad=e.path[3].childNodes[27].innerHTML;
        var contraseña=e.path[3].childNodes[29].innerHTML;
        var rol=e.path[3].childNodes[31].innerHTML;
        //Conseguir valores
        ...
        document.getElementById('ModUniversidad').value=universidad;
    ...
    if (e.target.innerHTML === 'Borrar'){
        var id = e.path[3].childNodes[5].innerHTML
        eliminar(id);}
    })
...
modificar.addEventListener('submit', function(e) {
    ...
    var mUniversidad= datosModificar.get('ModUniversidad');
    ...
    fetch(url2, {
        ...
        body: JSON.stringify({
           ...
           "sexo": `${e.target.ModSexo.value}`,
            ...
            "universidad": `${e.target.ModUniversidad.value}`,
